...
<div class="panel panel-default">
	...
	<h3 class="panel-heading" >Edit New Product </h3>
...
<form name="form1" action="{{route('Product/update')}}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="p_name" value= "{{$product_name}}" class="form-control" placeholder="Enter Prodect Name" onBlur="return validate();" autocomplete="off">
		 ...
		 <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="p_price"  value= "{{$product_price}}" class="form-control" placeholder="Enter Product Price" autocomplete="off" onBlur="return validate1();" onKeyUp="if(/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="p_description" placeholder="Enter Product Description"autocomplete="off" onBlur="return validate2();">{{$product_desccription}}</textarea>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Image:</strong>
				  <input type="hidden" name="prod_id" value= "{{$id}}" multiple  class="form-control" >
                <input type="file" name="files[]" value= "{{$product_image}}" multiple  class="form-control" >
				   <?php $i=1;?>
				  @foreach ($product_ima as $item)
			     <a  href="#"><img src="{{asset('/image/' . $item)}}" ></i></a>
                 <?php $i++;?>
				@endforeach
